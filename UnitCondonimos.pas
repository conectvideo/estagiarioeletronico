...
begin
  inherited;
  dm.qryCondonimos.Edit;
  vFrmCondonimosCad.IdCondonimos := Dm.qryCondonimos.FieldByName('ID').AsInteger;

  if IsD2BridgeContext then
     ShowPopupModal('PopupCondominioCad') //mudar nome da popup
  else
  begin
...
procedure TFrmCondonimos.ListarCondonimos;
begin
  Dm.ListarCondonimos(Edit1.Text);
end;
